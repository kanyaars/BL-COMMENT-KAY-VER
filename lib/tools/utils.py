...
{red}                                                                                   
    ...
    #                                          ###                                 
     ##                                 #####   ###                                
    "BL-COMMENT-KAY-VER"              /#######  /#   by Kanyaars                                
    Lo kira lo bisa ngalahin gue?    /      ###/    github.com/kanyaars
{reset}
'''
...
red_texts = [
    ...
    f"{red}[2] Nofollow{reset}",
    f"{red}Buruan lo pilih 1 atau 2, kaga ada angka 3:{reset}",
